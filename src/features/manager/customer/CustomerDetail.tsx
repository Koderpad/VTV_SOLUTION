    ...
    return (
        <div className="container mx-auto px-4 sm:px-8">
                    ...
                    <tr>
                        ...
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                            {Array.from(customer.roles).map((role, index) => (
                                <span key={index} className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">{roleToString[role]}</span>
                            ))}
                        </td>
                    </tr>
                    </tbody>
            ...
            <div className="mt-4 flex justify-center">
                <button onClick={() => navigate('/manager/customers')} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
