...
import DeliverManagerTransportPage from "@/pages/deliver-manager/DeliverManagerTransportPage.tsx";
                    ...
                    <Route element={<RequireAuth allowedRoles={["DELIVER_MANAGER"]}/>}>
                        ...
                        >
                            ...
                            <Route
                                ...
                                element={<StatisticsTransportsPage/>}
                            />
                            <Route path="transports" element={<DeliverManagerTransportPage/>}/>
                            <Route
                                path="transport/detail/:transportId"
                                element={<TransportDetail/>}
                            />
