...
const StatisticsTransportsPage = () => {
    ...
    return (
        <div className="p-4">
            ...
            {(transportsLoading) && <p className="text-center">Đang tải...</p>}
            {(transportsError) && <p className="text-center text-red-500">Lỗi khi lấy dữ liệu</p>}
            {transportsData && (
                <div>
...
export default StatisticsTransportsPage;